...
import { Observable, Subject, delay, isObservable, takeUntil, tap } from 'rxjs';
...
import { CommonPaginate } from '../../typings/common-sort-paginate';
...
export class CommonTableComponent<T> implements AfterViewInit, OnDestroy {
  ...
  @Output()
  public paginate = new EventEmitter<CommonPaginate>();
